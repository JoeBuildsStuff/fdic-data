        ...
        >
          ...
          <SelectContent>
            {institutions.map((inst) => (
              <SelectItem key={inst.id} value={inst.id.toString()}> {/* Value must be string */}
        ...
        >
          ...
          <SelectContent>
             {reportPeriods.map((period) => (
              <SelectItem key={period.report_period_id} value={period.report_period_id.toString()}> {/* Value must be string */}
                {period.report_date}
              </SelectItem>
            ))}
           </SelectContent>
